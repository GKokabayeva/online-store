...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        <tr>
            <td><b>Total: </b></td>
            <td>
                <asp:Literal ID="litTotal" runat="server" Text=""></asp:Literal></td>
        </tr>

        <tr>
            <td><b>Vat: </b></td>
            <td>
                <asp:Literal ID="LitVat" runat="server" Text=""></asp:Literal></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:Literal ID="LitTotalAmount" runat="server" Text=""></asp:Literal></td>
        </tr>
